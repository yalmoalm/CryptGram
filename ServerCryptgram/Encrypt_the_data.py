...
class Encryption_and_Decryption:
    ...
    def Encrypt(self, DataToEncrypt): # A function for encrypting the data.
        ...
        # 2.encode("utf-16"): Encodes the resulting string into UTF-8 format, which converts the string into a byte sequence.
    ...
    def Decrypt(self, DataToDecrypt): # A function for decoding the data.
        ...
        decoded_data = base64.b64decode(DataToDecrypt).decode()
        ...
        # 2.decode("utf-16"): Converts the byte sequence into a string using the UTF-8 encoding. 
...
def main():
    ...
    x= encrypt_and_decrypt.Encrypt("stringgg to encrypt")
    print("encrypt data:", x)
    y=encrypt_and_decrypt.Decrypt(x)
    print("Decrypt Data", y)
